...
if ( ! function_exists ( 'oxsn_list_page_children_plugin_nav_item' ) ) {

	add_action('admin_menu', 'oxsn_list_page_children_plugin_nav_item', 99);
	function oxsn_list_page_children_plugin_nav_item() {

		add_submenu_page('oxsn-dashboard', 'Oxsn List Page Children', 'List Page Children', 'manage_options', 'oxsn-list-page-children', 'oxsn_list_page_children_plugin');

	}

}

if ( !function_exists('oxsn_list_page_children_plugin') ) {

	function oxsn_list_page_children_plugin() {
	...
	?>
		...
		<div class="wrap oxsn_settings_page">
			...
			<h2>Oxsn List Page Children Plugin</h2>
					...
					<div class="oxsn_xs_float_left oxsn_xs_width_100pr oxsn_sm_width_40pr oxsn_xs_padding_left_0px oxsn_sm_padding_left_10px">
						...
						<div class="postbox">
							...
							<div class="inside">
								...
								<p><a href="https://wordpress.org/support/plugin/oxsn-navigation" target="_blank" class="button button-primary button-large">Support</a></p>
